...
if($('#notfound').length){
  const episodes=[
    {
      t:"「佐伯の殿様、浦で持つ」",
      e:"佐伯を語るときによく使われる言葉です。江戸時代からある言葉で、正しくは「佐伯の殿様浦で持つ、浦の恵みは山で持つ」と言います。佐伯市の漁業が藩財政を支えていたことを表す言葉です。佐伯藩は、リアス式海岸であるため浦が多く、漁業と海上輸送基地の港として活用されていました。また、林業も藩財政を支える収入源の一つでした。佐伯市は、九州で最大規模の森林があり、一級河川の番匠川が流れ、そして豊かな漁場がある浦をもっています。日向灘の荒波と豊後水道に育まれた海の幸、広大な森林や清流に育まれた山の幸などの豊かな恵みがあります。",
      i:""
    },{
      t:"城山",
      e:"佐伯市街のほぼ中央に位置する城山。標高は144m、もともとは「八幡山」という名前でしたが江戸時代に佐伯城が築城され、城山と呼ばれるようになりました。佐伯城は1606年に佐伯藩の初代藩主である毛利高政によって築かれましたが、廃藩置県の際に取り壊されました。城山の山頂からは、佐伯の街だけでなく、晴れた澄んだ日には四国も見えると言われています。林の中には340種の植物があり、その中には珍しい草木が多くみられます。佐伯で育った人ならば、遠足やハイキング、部活動などで一度は登ったことのある山で、ふるさとの風景として挙げる市民も多い山です。令和5年3月、国史跡に指定されました。",
      i:""
    },{
      t:"テキストテキストテキストテキストテキストテキスト",
      e:"テキスト1テキスト3テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1"
    },{
      t:"テキストテキストテキストテキストテキスト",
      e:"テキスト1テキスト4テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1"
    },{
      t:"テキストテキストテキストテキストテキストテキスト",
      e:"テキスト1テキスト5テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1テキスト1"
    },
  ]
  var min = 0 ;
